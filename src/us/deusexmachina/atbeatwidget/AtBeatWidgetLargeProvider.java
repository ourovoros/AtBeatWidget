...
public class AtBeatWidgetLargeProvider extends AppWidgetProvider{
	...
	private void setAlarm(Context context) {
		//Log.d(TAG, "setAlarm");
		Intent alarmIntent = new Intent(context, AtBeatWidgetLargeProvider.class);
	...
	public static RemoteViews settingsPreference(Context context){
		...
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(),R.layout.atbeat_widget_large);
	...
	public static class AtBeatService extends Service{
		...
		public void onStart(Intent intent, int startId){
            ...
            RemoteViews remoteViews = new RemoteViews(getPackageName(), R.layout.atbeat_widget_large);
			...
			ComponentName componentName = new ComponentName(this, AtBeatWidgetLargeProvider.class);
